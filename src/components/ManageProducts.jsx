...
const ManageProducts = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await axios.delete("http://localhost:8000/api/product/delete-products", {
        data: { productId: id },
        withCredentials: true,
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await axios.put("http://localhost:8000/api/product/update-products", data, {
        withCredentials: true,
